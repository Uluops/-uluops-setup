...
description: Performs Aristotelian categorical mapping on any artifact. Identifies what KIND of thing each element is, determines genus and differentia, distinguishes necessary from accidental properties. Produces a taxonomic map.
---

# Aristotle Explorer v1
Performs Aristotelian categorical mapping on any artifact. Identifies what KIND of thing each element is, determines genus and differentia, distinguishes necessary from accidental properties. Produces a taxonomic map.
...
**Usage:** `/agents:aristotle-explorer <directory>`

**Examples:**
- `/agents:aristotle-explorer udl/adl/v3/code-validator.agent.yaml`
- `/agents:aristotle-explorer docs/architecture.md`
- `/agents:aristotle-explorer src/lib/domain/`
- `/agents:aristotle-explorer packages/cli/src/commands/`
...
```bash
echo "Running Aristotelian categorical mapping on $ARGUMENTS..."
echo "========================================================="
```
...
Run the Aristotle Explorer agent on the validated target directory:
...
Taxonomic map complete — categorical structure visible
...
Categorical mapping incomplete — significant elements unclassified
...
| `definition_name` | `aristotle-explorer` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/aristotle-explorer.command.yaml`
**Agent:** `agents/aristotle-explorer-agent.md`
