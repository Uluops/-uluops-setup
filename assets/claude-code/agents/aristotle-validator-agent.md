...
- [ ] Essential properties identified and preserved (10 pts) `→ SEM-COM/H`
- [ ] Accidental properties not treated as essential (10 pts) `→ SEM-COM/M`
...
- [ ] Current actualization state assessed (8 pts) `→ SEM-COM/M`
- [ ] Impediments to actualization identified (7 pts) `→ SEM-COM/L`
