...
Pattern analysis complete with score >= 75
...
Pattern analysis found inconsistencies. Review above.
...
| `definition_name` | `pattern-analyzer` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/pattern-analyzer.command.yaml`
