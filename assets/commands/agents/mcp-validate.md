...
MCP validation passed with score >= 80
...
MCP validation failed. Review issues above.
...
| `definition_name` | `mcp-validate` | From CDL interface |
...
**CDL Source:** `/Users/aself/uluops/uluops-agent-workflows/udl/cdl/v1/mcp-validate.command.yaml`
