...
- [ ] Consistent formatting throughout (5 pts) `→ STR-INC/L`  *Verify:* Same patterns used for similar content, No mixed formatting for same content types
...
- [ ] No conflicting instructions (5 pts) `→ SEM-COH/C`  *Verify:* No section contradicts another, No contradictory guidance present
